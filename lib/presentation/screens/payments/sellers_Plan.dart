...
class SellersPlanScreen extends StatelessWidget {
            ...
            children: [
              ...
              Table(
                ...
                children: [
                  ...
                  _buildTableRow('VALIDITY', 'Website Only', '6 Month',
                      '12 Month', screenWidth),
                  _buildTableRow('REGISTRATION CHARGES', '₹1000/-',
                      '₹1000 + GST', '₹1000 + GST', screenWidth),
                  _buildTableRow('POSTPAID CHARGES', '₹0', '₹1000',
                      '₹1% Brokerage of market value', screenWidth),
                  _buildTableRow('Reference number or site visit', '1', '21',
                      'TILL SALE', screenWidth),
                  _buildTableRow('Photo Shoot/ Video Charges', '₹2000', '₹2000',
                      '₹2000', screenWidth),
                  _buildIconRow('100% privacy of your data', true, true, true,
                      screenWidth),
                  _buildIconRow(
                      'Filtration of property', true, true, true, screenWidth),
                  _buildIconRow('New property alert on mobile', true, true,
                      true, screenWidth),
                  _buildIconRow(
                      'Home loan assistance', false, true, true, screenWidth),
                  _buildIconRow(
                      'Legal Assistance', false, true, true, screenWidth),
  ...
  void handleButtonPress(int index, context) {
    ...
    BlocProvider.of<BuyerPlanBloc>(context)
        .add(FetchBuyerPlans(planType, "Sellers"));
  }
}
