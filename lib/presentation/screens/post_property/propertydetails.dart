              ...
              buildCard(
                child: Column(
                  children: [
                    ...
                    _buildDropdownField("Property Type", selectedPropertyType, [
                      "Row House",
                    ...
                    _buildTextField(
                        "Carpet/BuiltUp Area (Sq. Ft.)", carpetAreaController),
                    _buildDropdownField("Total Floor", selectedTotalFloor,
                        ["Ground Only", "Ground+1", "Ground+2", "Ground+3"]),
                    _buildDropdownField("Ownership Type", selectedOwnershipType,
                        ["On lease", "Self Owned"]),
              ...
              buildCard(
                child: Column(
                  children: [
                    ...
                    _buildTextField(
                        "Maintenance Cost (/month)", maintenanceCostController),
                    _buildCheckbox(
              ...
              buildCard(
                child: Column(
                  children: [
                    ...
                    _buildDropdownField(
                        "Balcony", selectedBalcony, ["1", "2", "3", "4", "5"]),
