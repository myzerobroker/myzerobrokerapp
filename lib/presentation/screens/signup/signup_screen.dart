        ...
        child: BlocListener<SignupBloc, SignUpState>(
          listener: (context, state) {
            if (state.signupStatus == SignUpStatus.loading) {
              ...
              ScaffoldMessenger.of(context)
                ..hideCurrentSnackBar()
                ..showSnackBar(SnackBar(content: Text(state.message ?? 'Error occurred')));
            }
          },
                              ...
                              return Column(
                                children: [
                                  Textfield(
                                    ...
                                    hintText: "Full Name",
                                    onChanged: (value) {
                                      context.read<SignupBloc>().add(fullNameChanged(fullName: value));
                                    },
                                  ),
                                  SizedBox(height: height * 0.02),
                                  Textfield(
                                  ...
                                  Textfield(
                                    ...
                                    onChanged: (value) {
                                      context.read<SignupBloc>().add(phoneNoChanged(phoneNo: value));
                                    },
                                  ),
                                  SizedBox(height: height * 0.02),
                                  Elevatedbutton(
